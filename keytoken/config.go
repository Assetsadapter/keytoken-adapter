...
func (this *WalletConfig) LoadConfig(configFilePath string, configFileName string) (*WalletConfig, error) {
	...
	//	this.ChainId = 12
	this.EthereumKeyPath = c.String("EthereumKeyPath") //"/Users/peter/workspace/bitcoin/wallet/src/github.com/keytoken/go-keytoken/chain/keystore"
	//每次都向节点查询nonce
...
//	c.EthereumKeyPath = "/Users/peter/workspace/bitcoin/wallet/src/github.com/keytoken/go-keytoken/chain/keystore"
//	c.ChainID = 12
//	this.Config = &c
//	//创建目录
//	file.MkdirAll(c.DbPath)
